...
export class UsuariosController {
    ...
    static async crearUsuario(c) {
        try {
            ...
            const { dni, nombres, apellidos, email, telefono, direccion, fecha_nacimiento, genero, rol_id, password, activo = true, turno, apoderado, // Datos del apoderado para crear
            // Campos adicionales para profesores
            tipo_profesor, especialidad, codigo_profesor, fecha_ingreso } = body;
    ...
    static async actualizarUsuario(c) {
        try {
            ...
            const { dni, nombres, apellidos, email, telefono, direccion, fecha_nacimiento, genero, rol_id, activo, turno, 
            // Campos adicionales para apoderados
            telefono_emergencia, ocupacion, 
            // Campos adicionales para profesores
            tipo_profesor, especialidad } = body;
