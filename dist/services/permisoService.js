...
export const permisoService = {
     ...
     */
    async crearNotificacionProfesor(solicitud) {
        try {
     ...
     */
    async crearNotificacionApoderado(solicitudId, accion, observaciones) {
        try {
     ...
     */
    async obtenerEstadisticasPermisos(apoderadoId) {
        try {
     ...
     */
    async validarPermisoDisponible(estudianteId, fechaPermiso) {
        try {
     ...
     */
    async marcarComoJustificado(solicitudId) {
        try {
     ...
     */
    async obtenerPermisosProximos(apoderadoId) {
        try {
...
//# sourceMappingURL=permisoService.js.map