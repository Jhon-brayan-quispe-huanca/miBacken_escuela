...
export class NotificacionService {
    ...
    static async obtenerNotificaciones(usuarioId, opciones = {}) {
        try {
            const { limit = 20, offset = 0, categoria, prioridad, leido, } = opciones;
            const where = {
     ...
     */
    static async obtenerContadorNoLeidas(usuarioId) {
        try {
     ...
     */
    static async crearNotificacionAsistencia(estudianteId, apoderadoId, datosAsistencia) {
        try {
     ...
     */
    static async crearNotificacionPermiso(solicitudId, tipo) {
        try {
