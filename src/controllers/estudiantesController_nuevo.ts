...
export class EstudiantesController {
  ...
  static async obtenerEstudiantes(c: Context) {
    try {
  ...
  static async obtenerEstudiantePorId(c: Context) {
    try {
      const user = c.get('user');
  ...
  static async crearEstudiante(c: Context) {
    try {
      const user = c.get('user');
  ...
  static async actualizarEstudiante(c: Context) {
    try {
      const user = c.get('user');
  ...
  static async cambiarEstadoEstudiante(c: Context) {
    try {
      const user = c.get('user');
  ...
  // Eliminar estudiante
  static async eliminarEstudiante(c: Context) {
    try {
      const user = c.get('user');
  ...
  static async obtenerGradosYSecciones(c: Context) {
    try {
      const user = c.get('user');
  ...
  static async obtenerApoderados(c: Context) {
    try {
      const user = c.get('user');
