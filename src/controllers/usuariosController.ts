    ...
    try {
      ...
      const [usuarios, total] = await Promise.race([
        ...
        new Promise<never>((_, reject) => 
          setTimeout(() => reject(new Error('Timeout: Consulta tardó demasiado')), 8000)
        )
      ]);
  ...
  static async obtenerUsuarioPorId(c: Context) {
    ...
    try {
      ...
      const usuario = await Promise.race([
        ...
        new Promise<never>((_, reject) => 
          setTimeout(() => reject(new Error('Timeout: Consulta tardó demasiado')), 5000)
        )
      ]);
  ...
  static async crearUsuario(c: Context) {
    ...
    try {
      ...
      const usuarioExistente = await Promise.race([
        ...
        new Promise<never>((_, reject) => 
          setTimeout(() => reject(new Error('Timeout: Verificación tardó demasiado')), 5000)
        )
      ]);
      ...
      const nuevoUsuario = await Promise.race([
        ...
        new Promise<never>((_, reject) => 
          setTimeout(() => reject(new Error('Timeout: Creación tardó demasiado')), 8000)
        )
      ]);
  ...
  static async actualizarUsuario(c: Context) {
    ...
    try {
      ...
      const usuarioActualizado = await Promise.race([
        ...
        new Promise<never>((_, reject) => 
          setTimeout(() => reject(new Error('Timeout: Actualización tardó demasiado')), 8000)
        )
      ]);
  ...
  static async eliminarUsuario(c: Context) {
    ...
    try {
      ...
      await Promise.race([
        ...
        new Promise<never>((_, reject) => 
          setTimeout(() => reject(new Error('Timeout: Eliminación tardó demasiado')), 8000)
        )
      ]);
